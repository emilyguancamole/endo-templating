...
from templating.generate_from_fields import load_fields_config, generate_single, build_report_sections
import pandas as pd
...
def demo():
    ...
    print(f"\nUsing demo data file (templating/demo_data/{args.demo_data_json})...")
    ...
    print(f"\nProcedure note written to: {output_path}\n")
